...
!function(e){
	e.fn.poptrox_disableSelection=function(){
		...
		function t(){
			p=e(window).width(),s=e(window).height()+r.windowHeightPad;var o=Math.abs(x.width()-x.outerWidth()),t=Math.abs(x.height()-x.outerHeight()),i=(w.width(),w.height(),p-2*r.windowMargin-o),n=s-2*r.windowMargin-t;
			x.css("min-width",r.popupWidth).css("min-height",r.popupHeight),v.children().css("max-width",i).css("max-height",n)}if(0==this.length)return e(this);if(this.length>1){
				for(var i=0;i<this.length;i++)e(this[i]).poptrox(o);
					return e(this)}var p,s,r=e.extend({
